                                ...
                                @foreach ($proveedores as $proveedor)
                                    ...
                                    <td class="text-center ">
                                        <a class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold  rounded " href="{{route('proveedores.edit', $proveedor)}}" >
                                            <svg class="h-6 w-9"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="white">
                                    ...
                                    <td class="text-left py-3 px-4"><form action="{{route('proveedores.destroy', $proveedor)}}" method="POST">
                                        ...
                                        <div class="w-20 text-center" >
                                            <button type="submit" class="inline-block bg-red-500 hover:bg-red-700 text-white font-bold  rounded  w-1/3 h-6">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                    </svg>
                                            </button>
                                            <a  class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold w-1/3 rounded  " href="{{route('proveedores.edit', $proveedor)}}">
